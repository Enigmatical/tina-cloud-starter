...
import YearPage, { query, YearQueryResponseType } from "../../years/[filename]";
...
export default function AdminPage(props) {
  const [payload, isLoading] = useGraphqlForms<YearQueryResponseType>({
    query,
  ...
  useDocumentCreatorPlugin(
    ...
    (collections) => {
      return collections.filter(({ label }) => label === "Years");
    }
  );

  return isLoading ? <p>Loading...</p> : <YearPage {...payload} />;
}
